...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text("Plastic Detection prototype"), backgroundColor: Color.fromARGB(255, 2, 142, 128),automaticallyImplyLeading: false),
      backgroundColor: Color.fromARGB(255, 103, 184, 193),
      body: Center(
          child: Column(
        ...
        children: [
          ...
          ElevatedButton(
            ...
            style: ElevatedButton.styleFrom(backgroundColor: Color.fromARGB(255, 0, 51, 59)),
